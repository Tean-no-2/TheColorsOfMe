	...
	<main class="payinfo">
        ...
        <div class="apear-tag">
          ...
          <div class="email-on">
            ...
            <br>
            <input class="change-cancel" type="submit" value="변경 취소">&nbsp<input class="sending" type="submit"
              value="인증메일 발송">
          ...
          <div>
            ...
            <div><input type="text"> <input class="change-btn2" type="submit" value="우편번호 검색">
              <div><input type="text" class="address" placeholder="주소"> </div>
              <div><input type="text" class="address" placeholder="상세주소"> </div>
              <div> <input class="fix-btn" type="submit" value="저장하기"></div>
            </div>
          </div>
        </div>
      </div>
