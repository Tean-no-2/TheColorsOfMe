...
<div class="grid">
    <div class="grid-img">
      <img class="img-main" src="${root }image/${dto.product_img}"></img>
      
      <div class="img-sub">
      <c:forEach var="img" items="${img }">
        <img class="img-sub1 sub-small" src="${root }image/${dto.product_color }/${img.main_img}"></img>
    ...
    <div class="grid-content">
      ...
      <div class="content-delivery">택 &nbsp;&nbsp;배 - 3000원 (주문시 결제)</span>
      </div>
        ...
        <div class="counter-title">
          <div class="counter-counts"> 
            <dl> 
              <dd> 
                <div class="qty"> 
                  ...
                  <input type="text" name="amount" id="ct_qty" value="1" readonly="readonly"> 
                  <div class="plus">
            ...
            <dl class="counts-price"> 
              <dd id="#total_amount" class="counts-count">${dto.product_price }</dd><dd>&nbsp;원&nbsp;</dd> 
            </dl> 
          </div>
        </div>
      </div>
      <div id="#total_amount2" class="content-priceall">
        <span>총 상품금액</span>
        <dl class="counts-price"> 
          <dd id="#total_amount2" class="counts-count2">${dto.product_price }</dd>
        </dl> <span>&nbsp;원</span>
      </div>
...
<%--   <form name="form1" method="get" action="${root }cart/insert.do">
  ...
  <div class="gridlast">
    ...
    <div class="last-img">
      <span class="img-1"><img src="${root }image/orange/pum1.png"></span>
      <span class="img-2"><img src="${root }image/orange/orange1.png"></span>
      <span class="img-3"><img src="${root }image/orange/carrot1.png"></span>
      <span class="img-4"><img src="${root }image/orange/paprika1.png"></span>
      <span class="img-5"><img src="${root }image/orange/banana1.png"></span>
      <span class="img-6"><img src="${root }image/orange/pineapple1.png"></span>
